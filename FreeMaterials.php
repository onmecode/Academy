...
<html>
    ...
    <body>
        ...
        <h1><div align="center">Academy Library and Learning Tools 
             <div id="logo">
                 <a href="index.php"><img src="images/CodingZuill.jpg" alt="Believe in Better" width="150"height="150"/></a>
            </div>
            FREE MATERIALS
            </div></h1>
    ...
    <li><a href="forum.php" target="_blank">Forum</a></li>
            ...
            <table class="two">
                   ...
                   <tr>
                       <td><a href="NewExp.php">UPLOAD NEW App 
                           </a></td> 
               ...
               <?php
                $pdo = database_connect();
                  $query ='SELECT `image`,`title`,`author`FROM `materials` ORDER BY  `title`';
                 foreach ($pdo->query($query)as $row){
                     echo '<tr>     ',$row['image'],'<br>',$row['title'],'<br>',$row['author'],'    </td>','</tr>','</br>';
                 }
